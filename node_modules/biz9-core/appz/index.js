...
module.exports = function(app_config){
    ...
    bind_biz_item = function(item,org_item){
        if(org_item.field_1){
            item.field_1=org_item.field_1 ? (org_item.field_1) : "";
        }
        if(org_item.field_2){
            item.field_2=org_item.field_2 ? (org_item.field_2) : "";
        }
        if(org_item.field_3){
            item.field_3=org_item.field_3 ? (org_item.field_3) : "";
        }
        if(org_item.field_4){
            item.field_4=org_item.field_4 ? (org_item.field_4) : "";
        }
        if(org_item.field_5){
            item.field_5=org_item.field_5 ? (org_item.field_5) : "";
        }
        if(org_item.field_6){
            item.field_6=org_item.field_6 ? (org_item.field_6) : "";
        }
        if(org_item.field_7){

            item.field_7=org_item.field_7 ? (org_item.field_7) : "";
        }
        if(org_item.field_8){

            item.field_8=org_item.field_8 ? (org_item.field_8) : "";
        }
        if(org_item.field_9){
            item.field_9=org_item.field_9 ? (org_item.field_9) : "";
        }
        if(org_item.field_10){
            item.field_10=org_item.field_10 ? (org_item.field_10) : "";
        }
        if(org_item.field_11){
            item.field_11=org_item.field_11 ? (org_item.field_11) : "";
        }
        if(org_item.field_12){
            item.field_12=org_item.field_12 ? (org_item.field_12) : "";
        }
        if(org_item.field_13){
            item.field_13=org_item.field_13 ? (org_item.field_13) : "";
        }
        if(org_item.field_14){
            item.field_14=org_item.field_14 ? (org_item.field_14) : "";
        }
        if(org_item.field_15){

            item.field_15=org_item.field_15 ? (org_item.field_15) : "";
        }
        if(org_item.field_16){
            item.field_16=org_item.field_16 ? (org_item.field_16) : "";
        }
        if(org_item.field_17){
            item.field_17=org_item.field_17 ? (org_item.field_17) : "";
        }
        if(org_item.field_18){
            item.field_18=org_item.field_18 ? (org_item.field_18) : "";
        }
        if(org_item.field_19){
            item.field_19=org_item.field_19 ? (org_item.field_19) : "";
        }
        if(org_item.value_1){
            item.value_1=org_item.value_1 ? (org_item.value_1) : "";
        }
        if(org_item.value_2){
            item.value_2=org_item.value_2 ? (org_item.value_2) : "";
        }
        if(org_item.value_3){
            item.value_3=org_item.value_3 ? (org_item.value_3) : "";
        }
        if(org_item.value_4){
            item.value_4=org_item.value_4 ? (org_item.value_4) : "";
        }
        if(org_item.value_5){
            item.value_5=org_item.value_5 ? (org_item.value_5) : "";
        }
        if(org_item.value_6){
            item.value_6=org_item.value_6 ? (org_item.value_6) : "";
        }
        if(org_item.value_7){
            item.value_7=org_item.value_7 ? (org_item.value_7) : "";
        }
        if(org_item.value_8){
            item.value_8=org_item.value_8 ? (org_item.value_8) : "";
        }
        if(org_item.value_9){
            item.value_9=org_item.value_9 ? (org_item.value_9) : "";
        }
        if(org_item.value_10){
            item.value_10=org_item.value_10 ? (org_item.value_10) : "";
        }
        if(org_item.value_11){
            item.value_11=org_item.value_11 ? (org_item.value_11) : "";
        }
        if(org_item.value_12){
            item.value_12=org_item.value_12 ? (org_item.value_12) : "";
        }
        if(org_item.value_13){
            item.value_13=org_item.value_13 ? (org_item.value_13) : "";
        }
        if(org_item.value_14){
            item.value_14=org_item.value_14 ? (org_item.value_14) : "";
        }
        if(org_item.value_15){
            item.value_15=org_item.value_15 ? (org_item.value_15) : "";
        }
        if(org_item.value_16){
            item.value_16=org_item.value_16 ? (org_item.value_16) : "";
        }
        if(org_item.value_17){
            item.value_17=org_item.value_17 ? (org_item.value_17) : "";
        }
        if(org_item.value_18){
            item.value_18=org_item.value_18 ? (org_item.value_18) : "";
        }
        if(org_item.value_19){
            item.value_19=org_item.value_19 ? (org_item.value_19) : "";
        }
        if(org_item.date_1){
            item.date_l=org_item.date_1 ? (org_item.date_1) : "";
        }
        if(org_item.date_2){
            item.date_2=org_item.date_2 ? (org_item.date_2) : "";
        }
        if(org_item.date_3){
            item.date_3=org_item.date_3 ? (org_item.date_3) : "";
        }
        if(org_item.date_value_1){
            item.date_value_1=org_item.date_value_1 ? (org_item.date_value_1) : "";
        }
        if(org_item.date_value_2){
            item.date_value_2=org_item.date_value_2 ? (org_item.date_value_2) : "";
        }
        if(org_item.date_value_3){
            item.date_value_3=org_item.date_value_3 ? (org_item.date_value_3) : "";
        }
        return item;
    }
...
module.copy_top_item=function(db,data_type,tbl_id,callback) {
    item = biz9.get_new_item(data_type,tbl_id);
    //other_list = [];
    //sub_item_list = [];
    org_top_sub_item_list = [];
    new_top_sub_item_list = [];
    org_sub_item_list = [];
    new_sub_item_list = [];
    var error=null;
    async.series([
        ...
        function(call){
            biz9.copy_photo_list(db,tbl_id,item_copy.tbl_id,function(error,data_list) {
                call();
            });
        },
        function(call){
            sql = {parent_tbl_id:tbl_id};
            sort={date_create:1};
            biz9.get_sql(db,DT_ITEM,sql,sort,function(error,data_list) {
                org_top_sub_item_list = data_list;
                call();
            });
        },
        function(call){
            for(a=0;a<org_top_sub_item_list.length;a++){
                org_top_sub_item_list[a].is_parent=false;
                var _new_sub_item = biz9.set_new_sub_item(DT_ITEM,org_top_sub_item_list[a])
                _new_sub_item.parent_tbl_id=item_copy.tbl_id;
                _new_sub_item.parent_data_type=item_copy.data_type;
                _new_sub_item.top_tbl_id=item_copy.tbl_id;
                _new_sub_item.top_data_type=item_copy.data_type;
                new_top_sub_item_list.push(_new_sub_item);
            }
            call();
        },
        function(call){
            if(new_top_sub_item_list.length>0){
                biz9.update_list(db,new_top_sub_item_list,function(error,data_list) {
                    new_top_sub_item_list=data_list;
                    call();
                });
            }else{
                call();
        ...
        function(call){
            for(a=0;a<new_top_sub_item_list.length;a++){
                for(b=0;b<org_sub_item_list.length;b++){
                    if(new_top_sub_item_list[a].org_tbl_id==org_sub_item_list[b].parent_tbl_id){
                        var _sub_item = biz9.set_new_sub_item(DT_ITEM,org_sub_item_list[b]);
                        _sub_item.parent_tbl_id=new_top_sub_item_list[a].tbl_id;
                        _sub_item.parent_data_type=new_top_sub_item_list[a].data_type;
                        _sub_item.top_tbl_id=item_copy.tbl_id;
                        _sub_item.top_data_type=item_copy.data_type;
                        new_sub_item_list.push(_sub_item);
                    }
                }
            }
            call();
