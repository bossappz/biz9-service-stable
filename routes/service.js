...
//9_service_list
//9_list
router.get('/get_service_list/:category:/page_current',function(req, res) {
...
//9_service_cart_update
//9_cart_update
router.post("/cart_item/update/", function(req, res) {
    var helper = biz9.get_helper(req);
    helper.service = biz9.get_new_item(DT_SERVICE,helper.tbl_id);
    async.series([
        function(call){
            biz9.get_connect_db(helper.app_title_id,function(error,_db){
                db=_db;
        ...
        function(call){
            biz9.get_item(db,DT_SERVICE,helper.item_tbl_id,function(error,data) {
                helper.service=data;
                call();
            });
        },
        function(call){
            ...
            helper.cart_item.item_tbl_id=helper.service.tbl_id;
            helper.cart_item.item_data_type=helper.service.data_type;
            helper.cart_item.item_price=helper.service.price;
            helper.cart_item.item_money_price=biz9.get_money(helper.service.price);
            helper.cart_item.item_title=helper.service.title;
            helper.cart_item.item_quantity=helper.item_quantity;
            helper.cart_item.item_sub_note=helper.service.sub_note;
            helper.cart_item.item_category=helper.service.category;
            helper.cart_item.item_title_url=helper.service.title_url;
            ...
            helper.cart_item.photofilename=helper.service.photofilename;
...
router.post('/checkout/cashapp',function(req, res) {
    ...
    async.series([
        ...
        function(call){
            ...
            var send_in_blue_obj = biz_order.get_service_cart_checkout_confirmation_send_in_blue(customer,shipping,billing,cart,helper.order,mail);
