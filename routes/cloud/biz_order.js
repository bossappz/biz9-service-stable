module.exports = function(){
	...
	module.get_product_cart_checkout_confirmation_send_in_blue=function(customer,shipping,billing,cart,order,mail,callback){
		...
		sb_shipping={name:shipping.name,company:shipping.company,address:shipping.address,city:shipping.city,state:shipping.state,zip:shipping.zip,phone:shipping.phone};
