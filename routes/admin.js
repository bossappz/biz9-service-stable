...
router.get('/get_product_category/:title_url',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.product_category = biz9.get_new_item(G_DT_CATEGORY,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_blog_post_category/:title_url',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.blog_post_category = biz9.get_new_item(G_DT_CATEGORY,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_service_category/:title_url',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.service_category = biz9.get_new_item(G_DT_CATEGORY,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_gallery_category/:title_url',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.gallery_category = biz9.get_new_item(G_DT_CATEGORY,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_gallery_category_list/',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.gallery_category_list = biz9.get_new_item(G_DT_CATEGORY,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_gallery_list/',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.gallery_list = biz9.get_new_item(G_DT_GALLERY,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_blog_post_category_list/',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.blog_post_category_list = biz9.get_new_item(G_DT_CATEGORY,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_product_category_list/',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.product_category_list = biz9.get_new_item(G_DT_CATEGORY,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_service_category_list/',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.category_list = biz9.get_new_item(G_DT_CATEGORY,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_product_list',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.item = biz9.get_new_item(G_DT_PRODUCT,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_service_list',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.service_list = biz9.get_new_item(G_DT_SERVICE,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
		...
		function(call){
			...
			page_current=1;
			page_size=50;
			biz9.get_sql_paging(db,G_DT_SERVICE,sql,sort,page_current,page_size,function(error,data_list,total_item_count,page_page_count){
...
router.get('/get_comment',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.comment = biz9.get_new_item(G_DT_BLANK,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_document/:title_url',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.page = biz9.get_new_item(G_DT_DOCUMENT,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_service/:title_url',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.service = biz9.get_new_item(G_DT_SERVICE,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_product/:title_url',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.product = biz9.get_new_item(G_DT_PRODUCT,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_page/:title_url',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.page = biz9.get_new_item(G_DT_BLANK,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_user/:email',function(req, res) {
	...
	async.series([
		...
		function(call){
			...
			sort={};
			biz9.get_sql(db,G_DT_USER,sql,sort,function(error,data_list){
				if(data_list.length>0){
...
router.get('/get_about',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.about = biz9.get_new_item(G_DT_BLANK,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_welcome',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.welcome = biz9.get_new_item(G_DT_BLANK,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
		...
		function(call){
			...
			page_current=1;
			page_size=25;
			biz9.get_sql_paging(db,G_DT_GALLERY,sql,sort,page_current,page_size,function(error,data_list,total_item_count,page_page_count){
				helper.gallery_list=data_list;
				call();
			});
		},
...
router.post('/update_system', function(req, res, next) {
	var helper = biz9.get_helper(req);
	helper.primary = biz9.get_new_item(G_DT_ITEM_MAP,0);
	helper.user = biz9.set_item_data(G_DT_USER,0,req.body);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
		...
		function(call){
			biz9.update_item(db,G_DT_USER,helper.user,function(error,data) {
				helper.user=data;
				call();
			});
		},
...
router.get('/get_blog_post_list',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.blog_post_list = biz9.get_new_item(G_DT_BLOG_POST,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_blog_post/:title_url',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.blog_post = biz9.get_new_item(G_DT_BLOG_POST,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_team_list/',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.team_list = biz9.get_new_item(G_DT_TEAM,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_team/:title_url',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.team = biz9.get_new_item(G_DT_TEAM,0);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
...
router.get('/get_photo/:tbl_id',function(req, res) {
	var helper = biz9.get_helper(req);
	helper.item = biz9.get_new_item(G_DT_PHOTO,helper.tbl_id);
	async.series([
		function(call){
			biz9.get_connect_db(helper.app_title_id,function(error,_db){
				db=_db;
		...
		function(call){
	        ...
	        function(call){
            biz9.get_item(db,G_DT_PHOTO,helper.tbl_id, function(error,data) {
                helper.item =data;
                call();
            });
        },
