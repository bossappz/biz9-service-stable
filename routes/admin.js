    ...
    async.series([
        ...
        */
        ...
        function(call){
            ...
            helper.contact.form_visible="true";
            helper.contact.social_visible="true";
            helper.contact=biz9.convert_biz_item(helper.contact,['form_header','form_sub_note','form_visible','social_visible','social_header','social_sub_note'])
	...
	//member_category
        ...
        function(call){
            ...
            for(a=0;a<len;a++){
                ...
                blog_post.title='Blog Post Title '+ a;
	...
	//event_category
        ...
        function(call){
            ...
            for(a=0;a<len;a++){
                ...
                event.meeting_link='meeting_link '+ a;
                event.location='location '+ a;
	...
	//gallery_category
        ...
        function(call){
            ...
            for(a=0;a<len;a++){
                ...
                service.category=helper.service_category_list[biz9.get_id(helper.service_category_list.length)-1].title;
