...
router.get('/category_list/:page_current',function(req, res) {
    ...
    async.series([
        ...
        function(call){
            sort={date_create:1};
            page_size=22;
            biz9.get_category_biz_list(db,DT_PRODUCT,sort,helper.page_current,page_size,function(error,data_list,total_count,page_page_count) {
...
router.get('/product_detail/:title_url',function(req, res) {
    ...
    async.series([
        ...
        function(call){
            ...
            page_current=1;
            page_size=19;
            biz9.get_categoryz(db,DT_PRODUCT,sort,page_current,page_size,function(error,data_list,total_item_count,page_page_count){
                helper.category_list = data_list;
                call();
            });
        },
...
////9_option 9_product_option
router.get('/product_option/:product_tbl_id/:product_option_tbl_id/',function(req, res) {
    /*--default_start */
    var helper = biz9.get_helper(req);
    helper.mobile = biz9.get_new_item(DT_BLANK,0);
    helper.info = biz9.get_new_item(DT_BLANK,0);
 ...
 async.series([
        ...
        function(call){
            biz9.get_item(db,DT_PRODUCT,helper.product_tbl_id,function(error,data) {
                helper.product=data;
                call();
            });
        },
        function(call){
            biz9.get_item(db,DT_ITEM,helper.product_option_tbl_id,function(error,data) {
                helper.product_option=data;
                call();
            });
        },
        function(call){
            sql = {parent_tbl_id:helper.product_option_tbl_id};
            sort={};
            biz9.get_sql(db,DT_ITEM,sql,sort,function(error,data_list) {
                helper.product_option_item_list = data_list;
                call();
            });
        },
    ],
...
////9_option 9_product_option
router.get('/product_option_item/:product_tbl_id/:product_option_tbl_id/:product_option_item_tbl_id',function(req, res) {
       /*--default_start */
    var helper = biz9.get_helper(req);
    helper.mobile = biz9.get_new_item(DT_BLANK,0);
    helper.info = biz9.get_new_item(DT_BLANK,0);
 ...
 async.series([
        ...
        function(call){
            biz9.get_item(db,DT_ITEM,helper.product_option_item_tbl_id,function(error,data) {
                helper.product_option_item=data;
                call();
            });
        },
    ],
